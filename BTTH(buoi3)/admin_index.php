  ...
  <body>
    <header>
        ...
        <div class="container navbar">
            ...
            <nav class="nav-links">
                <a href="admin_index.php" class="active"><i class="fa-solid fa-wave-square"></i> Trang chủ</a>
                <a href="admin_haha.php"><i class="fa-solid fa-bag-shopping"></i> Nhà thuốc</a>
            </nav>
      ...
      <div class="hero-section">
        <div class="hero-content">
          ...
          <nav class="hero-buttons">
            ...
            <a href="admin_haha.php" class="btn btn-outline">Mua thuốc</a>
          </nav>
        </div>
